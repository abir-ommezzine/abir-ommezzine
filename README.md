...
- **[Stock Market Prediction Platform](https://github.com/abir-ommezzine/stock_market_dashboard)** : ARIMA-based time series forecasting with a microservices architecture (FastAPI, React, PostgreSQL, JWT auth, Docker)
- **[AI Chatbot for ENSI Robotics Club](https://github.com/abir-ommezzine/-Chatbot-ARE-Association-Robotique-ENSI-)** : RAG-powered chatbot over internal docs, using LangChain + ChromaDB
...
**AI/ML:** LLMs, RAG, multi-agent systems, time series forecasting, prompt engineering
**Backend:** FastAPI, LangGraph, Flask, Spring Boot, SQLAlchemy
**Frontend:** React, Angular
**Infra:** Docker, PostgreSQL, MySQL, Git
